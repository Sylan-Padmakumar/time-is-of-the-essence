...
class clock(button):
    ...
    def alarm():
        global i
        user_alarm_time = [alarm_hour.get(),alarm_min.get()]
...
my_button_snooze = Button(my_frame2, text = "snooze", command = snooze ,pady = 50).grid()
...
button_1 = Button(my_frame2, text = "enter", padx = 8, pady = 4,command = clock.alarm)
